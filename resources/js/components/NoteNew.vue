        ...
        <form action="/notes/create" method="POST" name="newNote">
            ...
            <div class="place">
                <div class="form-group py-2 px-3">
                    ...
                    <strong class="error" v-for="value in error.place">{{ value }}</strong>
            ...
            <div class="opponent">
                <div class="form-group py-2 px-3">
                    ...
                    <strong class="error" v-for="value in error.opponent">{{ value }}</strong>
            ...
            <div class="result">
                <div class="form-group py-2 px-3">
                    ...
                    <strong class="error" v-for="value in error.match_result_home">{{ value }}</strong>
                    <strong class="error" v-for="value in error.match_result_away">{{ value }}</strong>
                    <div class="flex text-center">
                        <input type="number" name="match_result_home" class="form-control w-1/5">
                        <span class="w-1/5 text-xl leading-loose">VS</span>
                        <input type="number" name="match_result_away" class="form-control w-1/5">
                    </div>
                </div>
            </div>
            ...
            <div class="url">
                <div class="form-group py-2 px-3">
                    ...
                    <strong class="error" v-for="value in error.url">{{ value }}</strong>
            ...
            <div class="impressions">
                <div class="form-group py-2 px-3">
                    ...
                    <strong class="error" v-for="value in error.impressions">{{ value }}</strong>
            ...
            <div class="comment">
                <div class="form-group py-2 px-3">
                    ...
                    <strong class="error" v-for="value in error.comment">{{ value }}</strong>
